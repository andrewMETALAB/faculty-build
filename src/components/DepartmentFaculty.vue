            ...
            <div class="col-sm-12 order-first order-md-last bg-light">
                <section>
                    <div class="container py-5">
                        <div class="departmentHeader mb-5 clearfix">
                            <h3 class="h4 departmentHeader__title">Computer Science</h3>
                            ...
                            <div class="departmentHeader__item pr-3">
                                <a href="#"><i class="fas fa-globe-americas"></i>Computer Science Website</a>
                            </div>
                            <div class="departmentHeader__item pr-3">
                        ...
                        <div class="row text-center py-2">
                            <div class="col-lg-4 col-sm-6 col-12 py-2 mb-4" >
                                <router-link to="/FacultyProfile/" class="card profile-card">
