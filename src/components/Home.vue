            ...
            <div class="row">                 
                <div class="col-md-4">
                    ...
                    <div class="FAC-degrees FACborder-line-wrapper">
                        ...
                        <ul class="list-unstyled">
                            <li class="timeline__header pb-3"><div><strong>D.Sc. Computer Science</strong></div> 1995, University of Massachusetts Lowell</li>
                            <li class="timeline__header pb-3"><div><strong>M.S. Computer Science</strong></div> 1990, University of Massachusetts Lowell</li>
                            <li class="timeline__header pb-3"><div><strong>B.S. Computer Science</strong></div> 1986, Lowell University</li>
                        </ul>
                    </div>
                ...
                <div class="col-md-8 pr-3">
                    ...
                    <h2 class="h3 text-primary">Overview</h2>
                    <div class="FAC-Overview__content mb-5">
